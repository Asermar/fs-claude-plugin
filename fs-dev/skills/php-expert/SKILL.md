...
El agente:
1. Consulta la documentación en `/home/alexis/.claude/plugins/cache/fs-claude-plugin/fs-dev/1.1.0/agents/docs/` (la-clase-tools, profundizando-en-el-core, el-archivo-init-php, gestion-de-errores)
