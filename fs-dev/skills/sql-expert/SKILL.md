...
El agente:
1. Consulta la documentación en `/home/alexis/.claude/plugins/cache/fs-claude-plugin/fs-dev/1.1.0/agents/docs/` (acceso-a-la-base-de-datos, dbquery, definición de tablas, relaciones, migraciones)
