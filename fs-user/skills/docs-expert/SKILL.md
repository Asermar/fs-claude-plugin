...
automáticamente en la carpeta `/home/alexis/.claude/plugins/cache/fs-claude-plugin/fs-user/1.0.0/agents/projects/` para identificar plugins que puedan
...
1. Ejecuta `Glob /home/alexis/.claude/plugins/cache/fs-claude-plugin/fs-user/1.0.0/agents/docs/**/*.md` para ver todos los archivos disponibles en el core
...
6. **Si no encuentra la funcionalidad en el core**, busca en `/home/alexis/.claude/plugins/cache/fs-claude-plugin/fs-user/1.0.0/agents/projects/` plugins relevantes
...
Agente lee: /home/alexis/.claude/plugins/cache/fs-claude-plugin/fs-user/1.0.0/agents/docs/tu-primer-cliente-459.md (y otros relevantes)
...
Agente busca en /home/alexis/.claude/plugins/cache/fs-claude-plugin/fs-user/1.0.0/agents/docs/ → sin resultados del core
Agente busca en /home/alexis/.claude/plugins/cache/fs-claude-plugin/fs-user/1.0.0/agents/projects/ → encuentra PrintTicket.md, POS.md
